...
<h1 style={{color:"#d4af37",fontSize:"34px",margin:"0"}}>STUDIO MP</h1>
<p style={{letterSpacing:"3px",fontSize:"11px",color:"#aaa"}}>NOVO HAMBURGO - RS</p>
...
<a href="https://wa.me/555180248090?text=Ola%20STUDIO%20MP%20quero%20agendar%20um%20horario" style={{display:"block",background:"#d4af37",color:"#000",padding:"18px",borderRadius:"12px",marginTop:"20px",fontWeight:"bold",textDecoration:"none"}}>AGENDAR NO WHATSAPP</a>

<p style={{marginTop:"20px",fontSize:"11px",color:"#666"}}>R. Bartolomeu de Gusmao, 1117<br/>Canudos - Novo Hamburgo</p>
</main>
)
}
