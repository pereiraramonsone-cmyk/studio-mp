...
<img src="https://raw.githubusercontent.com/pereiraramonsone-cmyk/studio-mp/main/app/IMG-20260912-WA0023.jpg" style={{width:"160px",height:"160px",borderRadius:"50%",objectFit:"cover",border:"3px solid #d4af37",margin:"0 auto",display:"block"}}/>
<h1 style={{color:"#d4af37",fontSize:"38px",margin:"15px 0 0 0",fontWeight:"900",letterSpacing:"2px"}}>STUDIO MP</h1>
<p style={{letterSpacing:"4px",fontSize:"12px",color:"#aaa",marginTop:"5px"}}>BARBEARIA</p>
<p style={{fontSize:"14px",color:"#d4af37",marginTop:"10px",fontWeight:"bold"}}>📍 Rua Icaro, 777 - Canudos<br/>Novo Hamburgo - RS</p>
</div>

{/* FOTOS DOS CORTES DEPOIS */}
...
<img src="https://raw.githubusercontent.com/pereiraramonsone-cmyk/studio-mp/main/app/IMG-20260912-WA0027.jpg" style={{width:"100%",borderRadius:"12px",aspectRatio:"1",objectFit:"cover"}}/>
</div>
...
<a href="https://wa.me/555180248090?text=Ola%20STUDIO%20MP%20da%20Rua%20Icaro%20777%20quero%20agendar" style={{display:"block",background:"#d4af37",color:"#000",padding:"18px",borderRadius:"12px",marginTop:"20px",fontWeight:"bold",textDecoration:"none",fontSize:"16px"}}>AGENDAR NO WHATSAPP</a>
